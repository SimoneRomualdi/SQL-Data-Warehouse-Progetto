...
Scopo della Procedura:
    Questa procedura carica i dati nello schema 'bronze' partendo da 
    file CSV esterni. La procedura esegue le seguenti operazioni:
    - Svuota le tabelle bronze prima di caricare i nuovi dati
    - Utilizza il comando COPY per il caricamento massivo dai file CSV
    - Monitora il tempo di esecuzione e il numero di righe caricate
    - Gestisce eventuali errori durante il processo di caricamento

Parametri:
    Nessuno. 
    Questa procedura non richiede parametri in input e non restituisce valori.
...
Note Tecniche:
    ...
    - Verificare i percorsi dei file prima dell'esecuzione
    - La procedura utilizza TRUNCATE per svuotare le tabelle (attenzione!)
    - In caso di errore, l'intera operazione viene interrotta
===============================================================================
*/
